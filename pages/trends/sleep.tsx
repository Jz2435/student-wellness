...
export default function SleepTrendPage() {
  ...
  const averageSleep =
    filteredReports.length > 0
      ? filteredReports.reduce((sum, r) => sum + r.sleep_hours, 0) /
        filteredReports.length
      : 0;
  const sleepQuality =
    averageSleep >= recommendedSleep
      ? "Good"
      : averageSleep >= 6
      ? "Fair"
      : "Poor";
        ...
        {reports.length > 0 ? (
          ...
          >
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: timeRange === key ? "#059669" : "white",
            ...
            >
              ...
              >
                ...
                >
                  {filteredReports.length > 0
                    ? Math.max(...filteredReports.map((r) => r.sleep_hours))
                    : 0}
                  h
                </div>
              </div>
              ...
              >
                ...
                >
                  {filteredReports.length > 0
                    ? Math.min(...filteredReports.map((r) => r.sleep_hours))
                    : 0}
                  h
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  >
                    ...
                    {filteredReports.length > 1 ? "Varies" : "N/A"}
                  </p>
                  <p style={{ fontSize: "14px", color: "#6b7280", margin: 0 }}>
                    <strong>Trend:</strong>{" "}
                    {filteredReports.length > 1 &&
                    filteredReports[filteredReports.length - 1].sleep_hours >
                      filteredReports[0].sleep_hours
                      ? "Improving"
                      : "Stable"}
                  </p>
                </div>
          ...
          >
            ...
            <p style={{ color: "#6b7280", marginBottom: "24px" }}>
              Submit your first sleep report to start tracking your rest
              patterns.
            </p>
