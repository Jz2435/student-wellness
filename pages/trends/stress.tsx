      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '24px', fontWeight: 700, color: '#dc2626' }}>
            {reports.length > 0 ? (reports.reduce((sum, r) => sum + r.stress_level, 0) / reports.length).toFixed(1) : '0'}/10
          </div>
        </div>
      </header>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: '#6b7280', marginBottom: '8px' }}>Highest Stress</div>
                <div style={{ fontSize: '24px', fontWeight: 700, color: '#dc2626' }}>
                  {Math.max(...reports.map(r => r.stress_level))}/10
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: '#6b7280', marginBottom: '8px' }}>Lowest Stress</div>
                <div style={{ fontSize: '24px', fontWeight: 700, color: '#059669' }}>
                  {Math.min(...reports.map(r => r.stress_level))}/10
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: '#6b7280', marginBottom: '8px' }}>Trend</div>
                <div style={{
                  fontSize: '24px',
                  fontWeight: 700,
                  color: reports.length > 1 && reports[reports.length - 1].stress_level < reports[0].stress_level ? '#059669' : '#dc2626'
                }}>
                  {reports.length > 1 && reports[reports.length - 1].stress_level < reports[0].stress_level ? '↓' : '↑'}
                </div>
              </div>
            </div>
          </div>
